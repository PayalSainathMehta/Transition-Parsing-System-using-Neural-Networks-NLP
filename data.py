...
def get_configuration_features(configuration: Configuration,
    ...
    childs = [st1, st2, st3, buf1, buf2, buf3, left_ch1_st1, right_ch1_st1, left_ch2_st1, right_ch2_st1, left_ch1_st2, right_ch1_st2,
              left_ch2_st2, right_ch2_st2, left_ch1_left_ch1_st1,right_ch1_right_ch1_st1, left_ch1_left_ch1_st2, right_ch1_right_ch1_st2]
    pos = []
